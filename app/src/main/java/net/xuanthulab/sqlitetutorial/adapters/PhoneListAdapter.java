package net.xuanthulab.sqlitetutorial.adapters;
...
import net.xuanthulab.sqlitetutorial.models.CompanyModel;
import net.xuanthulab.sqlitetutorial.models.DeviceModel;
